...
FLEX_STRENGTH_values = [0.0001, 0.0001, 0.0001, 0.0001, 
                        0.0008, 0.0008, 0.0008, 0.0008, 0.0008, 0.0006, 0.0006, 0.0006, 0.0006, 0.0006, 
...
MAX_PARALLEL = 56  # run 30 simulations at the same time
